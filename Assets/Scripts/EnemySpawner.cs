...
public class EnemySpawner : MonoBehaviour
{
	...
	IEnumerator SpawnMonster()
	{
		...
		while (transform.childCount < monsterCount)
		{
			...
			xPos = Random.Range(spawnerPos.x - 3, spawnerPos.x + 3);
			zPos = Random.Range(spawnerPos.z - 3, spawnerPos.z + 3);
			randomVector3 = new Vector3(xPos, this.gameObject.transform.position.y, zPos);
